...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32630',
            //extent: [275912.458600, 849914.001800, 276721.036400, 851078.005900],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([275912.458600, 849914.001800, 276721.036400, 851078.005900], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_Lignesdeparcours_18,
    colName: 'Point de départ',
    zoom: 10,
    collapsed: true,
    map: map,
    maxResults: 10,
